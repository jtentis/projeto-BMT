...
O problema também se relaciona à classificação de zonas retóricas em artigos científicos. Teufel e Moens \cite{teufel2002summarizing} mostraram que o papel argumentativo de sentenças pode apoiar tarefas como sumarização científica. Liakata et al. \cite{liakata2010corpora} discutem corpora e avaliação para rotulação automática de artigos científicos, destacando que a estrutura retórica exige categorias funcionais e critérios de anotação consistentes. Trabalhos recentes em sumarização de documentos científicos longos também exploram explicitamente estrutura discursiva para ranquear ou separar conteúdos centrais \cite{dong2021discourse,guo2023whatsnew}. O presente trabalho não treina um classificador retórico supervisionado, mas herda dessa literatura a ideia de que a posição textual não basta: uma seção deve ser entendida pelo papel que exerce no argumento do documento.

Na dimensão de comparação textual, o baseline usa TF-IDF e similaridade do cosseno. Essa escolha segue uma tradição clássica de recuperação de informação, na qual termos ponderados por frequência local e raridade global formam uma representação vetorial simples e interpretável \cite{manning2008ir}. Como contraponto, o projeto usa SciBERT, um BERT treinado em corpus científico de larga escala, criado para melhorar tarefas de PLN em textos acadêmicos e técnicos \cite{beltagy2019scibert}. Para documentos em português, modelos como BERTimbau mostram que pré-treinamento específico para o idioma pode melhorar tarefas de PLN em relação a modelos multilíngues genéricos \cite{souza2020bertimbau}. A comparação entre os dois métodos testa uma hipótese prática: uma representação contextual densa melhora a auditoria de alinhamento sem fine-tuning ou, neste cenário, a simplicidade lexical continua mais estável?
...
A validade externa também tem limites. O corpus cresceu para 50 documentos, mas continua concentrado em uma fonte institucional e em trabalhos acadêmicos com formatos heterogêneos. A generalização para outros repositórios, áreas e estilos editoriais exige nova coleta e nova auditoria. Estudos recentes de parsing de PDF mostram que ferramentas diferentes variam bastante conforme categoria documental, layout e tipo de conteúdo extraído \cite{li2024pdfparsing}. Além disso, o SciBERT foi treinado majoritariamente em literatura científica em inglês; seu uso em trabalhos em português pode preservar algumas regularidades científicas, mas não garante representação ideal para o idioma e o domínio local.
...
\bibitem{dong2021discourse}
Dong, Y., Mircea, A., and Cheung, J. C. K. (2021).
\newblock Discourse-Aware Unsupervised Summarization for Long Scientific Documents.
\newblock In \textit{Proceedings of the 16th Conference of the European Chapter of the Association for Computational Linguistics}, pages 1089--1102.
\newblock \url{https://aclanthology.org/2021.eacl-main.93/}.

\bibitem{guo2023whatsnew}
Guo, Y., Ren, X., and Frank, A. (2023).
\newblock What's New? Summarizing Contributions in Scientific Literature.
\newblock In \textit{Proceedings of the 17th Conference of the European Chapter of the Association for Computational Linguistics}, pages 1019--1031.
\newblock \url{https://aclanthology.org/2023.eacl-main.72/}.
...
\bibitem{li2024pdfparsing}
Li, Y., Cao, H., and Luo, Y. (2024).
\newblock A Comparative Study of PDF Parsing Tools Across Diverse Document Categories.
\newblock \textit{arXiv preprint arXiv:2410.09871}.
\newblock \url{https://arxiv.org/abs/2410.09871}.
...
\bibitem{nguyen2023bibliography}
Nguyen, T. T. H., Bottoni, P., and Alemu, G. (2023).
\newblock An End-to-End Pipeline for Bibliography Extraction from Scientific Publications.
\newblock In \textit{Proceedings of the Second Workshop on Information Extraction from Scientific Publications}, pages 92--103.
\newblock \url{https://aclanthology.org/2023.wiesp-1.12/}.
...
\newblock In \textit{Intelligent Systems}, pages 403--417. Springer.
\newblock \url{https://doi.org/10.1007/978-3-030-61377-8_28}.
